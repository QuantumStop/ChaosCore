...
public class FollowTheLeaderAction : MoveToAction
{
	...
	public FollowTheLeaderAction( AIController owner )
	{
		RegisterActionDefinition( AIActionDefinition.ActionList.ActionFollowTheLeader, owner );
	...
	public override void Perform( AIController agent )
	{
		...
		targetPosition = leader == agent ? agent.Scene.NavMesh.GetRandomPoint( agent.WorldPosition, 1024 ).Value : leader.WorldPosition;
